...
public:
    ...
    QGroupBox *groupBoxSkip;
    QWidget *verticalLayoutWidget_5;
    QVBoxLayout *verticalLayoutSkip;
    ...
    QPushButton *pushButtonSkipAccept;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        radioButtonSize_3->setChecked(false);
        ...
        radioButtonSize_4->setChecked(true);
        ...
        pushButtonZoom = new QPushButton(centralwidget);
        pushButtonZoom->setObjectName("pushButtonZoom");
        pushButtonZoom->setGeometry(QRect(1420, 740, 80, 30));
        pushButtonSkip = new QPushButton(centralwidget);
        pushButtonSkip->setObjectName("pushButtonSkip");
        pushButtonSkip->setGeometry(QRect(0, 200, 100, 30));
        groupBoxSkip = new QGroupBox(centralwidget);
        groupBoxSkip->setObjectName("groupBoxSkip");
        groupBoxSkip->setEnabled(true);
        groupBoxSkip->setGeometry(QRect(0, 230, 100, 90));
        verticalLayoutWidget_5 = new QWidget(groupBoxSkip);
        verticalLayoutWidget_5->setObjectName("verticalLayoutWidget_5");
        verticalLayoutWidget_5->setGeometry(QRect(0, 0, 101, 83));
        verticalLayoutSkip = new QVBoxLayout(verticalLayoutWidget_5);
        verticalLayoutSkip->setObjectName("verticalLayoutSkip");
        verticalLayoutSkip->setContentsMargins(0, 0, 0, 0);
        ...
        spinBox_LeftHalf = new QSpinBox(verticalLayoutWidget_5);
        spinBox_LeftHalf->setObjectName("spinBox_LeftHalf");

        verticalLayout_6->addWidget(spinBox_LeftHalf);
        ...
        spinBox_RightHalf = new QSpinBox(verticalLayoutWidget_5);
        ...
        verticalLayoutSkip->addLayout(horizontalLayout);

        pushButtonSkipAccept = new QPushButton(verticalLayoutWidget_5);
        pushButtonSkipAccept->setObjectName("pushButtonSkipAccept");

        verticalLayoutSkip->addWidget(pushButtonSkipAccept);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonZoom->setText(QCoreApplication::translate("MainWindow", "Zoom", nullptr));
        pushButtonSkip->setText(QCoreApplication::translate("MainWindow", "\320\237\321\200\320\276\320\277\321\203\321\201\320\272 \320\272\320\260\320\264\321\200\320\276\320\262", nullptr));
        groupBoxSkip->setTitle(QString());
        ...
        pushButtonSkipAccept->setText(QCoreApplication::translate("MainWindow", "\320\237\321\200\320\270\320\274\320\265\320\275\320\270\321\202\321\214", nullptr));
    } // retranslateUi
